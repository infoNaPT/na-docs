...
Para os participantes de cada reunião online:

- Não é necessário instalar qualquer programa para entrar numa reunião.
...
> devem enviar um email para os secretários do CSRP - [clica aqui para enviar](mailto:csrp.secretario@gmail.com)
> para obterem:
 - utilizador
 - palavra-passe
